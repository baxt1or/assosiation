                        ...
                        <div
                            ...
                            <div className='flex flex-col gap-y-8 mt-24 ml-2'>
                                <div className='flex flex-col gap-y-2'>
                                    <h1 className='text-2xl text-black font-bold text-center'>{person.name}</h1>
                                    <p className='text-xl text-[#001561] font-semibold text-center flex flex-col gap-y-1'>
                                        <span className='text-2xl font-bold '>{person.position} </span>
                                        Ассоциация представительств иностранных фармацевтических компаний и производителей в Республике Узбекистан</p>
                                </div>
