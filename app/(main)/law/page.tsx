...
const books = [
  {
    title:
      "О последовательном продолжении осуществляемых в системе здравоохранения реформ и создании необходимых условий для повышения потенциала медицинских работников",
    file: "",
                ...
                <div className="flex  items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-y-1">
                      <p className="text-xs font-normal text-black tracking-tighter">
                        {book.title}
                      </p>
                      <p className="text-xs font-normal text-black">
                        {book.date}
